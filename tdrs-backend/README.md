...
1.) For configuration of the `JWT_KEY` and `JWT_CERT_TEST` environment variables for local development/testing please refer to the the [jwt_key_management.md](docs/jwt_key_management.md) document. For configuration of a superuser for admin tasks please refer to the [super_user_management.md](docs/user_role_management.md) guide. 
