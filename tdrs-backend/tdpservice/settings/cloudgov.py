...
class Development(CloudGov):
    ...
    AV_SCAN_URL = os.getenv('AV_SCAN_URL', 'tanf-dev-clamav-rest.apps.internal')
...
class Staging(CloudGov):
    ...
    AV_SCAN_URL = os.getenv('AV_SCAN_URL', 'tanf-staging-clamav-rest.apps.internal')
...
class Production(CloudGov):
    ...
    AV_SCAN_URL = os.getenv('AV_SCAN_URL', 'tanf-prod-clamav-rest.apps.internal')
