...
from .users.api.authorization_check import AuthorizationCheck, KibanaAuthorizationCheck, GrafanaAuthorizationCheck
...
urlpatterns = [
    ...
    path("grafana_auth_check/", GrafanaAuthorizationCheck.as_view(), name="grafana-authorization-check"),
