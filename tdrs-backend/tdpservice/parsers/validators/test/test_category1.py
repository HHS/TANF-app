...
def _make_eargs(line):
    return ValidationErrorArgs(
        value=line, row_schema=test_schema, friendly_name="test field", item_num="1"
    )


def _validate_and_assert(
    validator, line, exp_result, exp_message, exp_deprecated=False
):
...
@pytest.mark.parametrize(
    "line, kwargs, exp_result, exp_message",
    [
        ("asdfasdf", {}, True, None),
        ("00000000", {}, True, None),
        (
            ...
            {},
            False,
            "Test Item 1 (test field): ######## contains blanks between positions 0 and 8.",
        ),
        (
            "        ",
            {},
...
@pytest.mark.parametrize(
    "line, length, kwargs, exp_result, exp_message",
    [
        ("1234", 4, {}, True, None),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            {},
            False,
            "Test: record length should be at least 4 characters but it is 3 characters.",
        ),
    ],
)
...
@pytest.mark.parametrize(
    "line, min, max, kwargs, exp_result, exp_message",
    [
        ("1234", 2, 6, {}, True, None),
        ("1234", 2, 4, {}, True, None),
        ("1234", 4, 6, {}, True, None),
        (
            ...
            {},
            False,
            "Test: record length of 4 characters is not in the range [1, 2].",
        ),
        (
            "1234",
            6,
            ...
            {},
            False,
            "Test: record length of 4 characters is not in the range [6, 8].",
        ),
    ],
)
...
@pytest.mark.parametrize(
    "line, substr, kwargs, exp_result, exp_message",
    [
        ("12345", "12", {}, True, None),
...
@pytest.mark.parametrize(
    "line, start, end, kwargs, exp_result, exp_message",
    [
        ("1234", 1, 3, {}, True, None),
        ("1004", 1, 3, {}, True, None),
...
@pytest.mark.parametrize(
    "line, validator, kwargs, exp_result, exp_message",
    [
        ("1234", category1.recordHasLength, {"length": 4}, True, None),
        (
            "    ",
            category1.recordIsNotEmpty,
            {},
            False,
            (
                "Test Item 1 (test field):      contains blanks "
...
def test_deprecated_cat1_validator(line, validator, kwargs, exp_result, exp_message):
    ...
    _validate_and_assert(
        deprecated_validator, line, exp_result, exp_message, exp_deprecated=True
    )
