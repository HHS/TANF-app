...
func convertTanfT2(record *parser.ParsedRecord, datafileID int32) [][]any {
	return singleRow([]any{
		...
		toText(record.Get("WORK_ELIGIBLE_INDICATOR")),
		...
		toText(record.Get("WORK_EXPERIENCE_HOP")),
		toText(record.Get("WORK_EXPERIENCE_EA")),
		toText(record.Get("WORK_EXPERIENCE_HOL")),
		toText(record.Get("OJT")),
		toText(record.Get("JOB_SEARCH_HOP")),
		toText(record.Get("JOB_SEARCH_EA")),
		toText(record.Get("JOB_SEARCH_HOL")),
		toText(record.Get("COMM_SERVICES_HOP")),
		toText(record.Get("COMM_SERVICES_EA")),
		toText(record.Get("COMM_SERVICES_HOL")),
		toText(record.Get("VOCATIONAL_ED_TRAINING_HOP")),
		toText(record.Get("VOCATIONAL_ED_TRAINING_EA")),
		toText(record.Get("VOCATIONAL_ED_TRAINING_HOL")),
		toText(record.Get("JOB_SKILLS_TRAINING_HOP")),
		toText(record.Get("JOB_SKILLS_TRAINING_EA")),
		toText(record.Get("JOB_SKILLS_TRAINING_HOL")),
		toText(record.Get("ED_NO_HIGH_SCHOOL_DIPL_HOP")),
		toText(record.Get("ED_NO_HIGH_SCHOOL_DIPL_EA")),
		toText(record.Get("ED_NO_HIGH_SCHOOL_DIPL_HOL")),
		toText(record.Get("SCHOOL_ATTENDENCE_HOP")),
		toText(record.Get("SCHOOL_ATTENDENCE_EA")),
		toText(record.Get("SCHOOL_ATTENDENCE_HOL")),
		toText(record.Get("PROVIDE_CC_HOP")),
		toText(record.Get("PROVIDE_CC_EA")),
		toText(record.Get("PROVIDE_CC_HOL")),
		toText(record.Get("OTHER_WORK_ACTIVITIES")),
		toText(record.Get("DEEMED_HOURS_FOR_OVERALL")),
		toText(record.Get("DEEMED_HOURS_FOR_TWO_PARENT")),
