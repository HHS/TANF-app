        ...
        RowSchema(
            ...
            postparsing_validators=[
                ...
                PostparsingValidators.ifThenAlso(
                    ...
                    result_function=PostparsingValidators.orValidators([
                        PostparsingValidators.isBetween(1, 9, inclusive=True, cast=int),
                ...
                PostparsingValidators.ifThenAlso(
                    ...
                    result_function=PostparsingValidators.isOneOf(
                        ["01", "02", "05", "07", "09", "15", "17", "18", "19", "99"]
                    ),
                ),
                PostparsingValidators.ifThenAlso(
                    condition_field_name="WORK_ELIGIBLE_INDICATOR",
                    condition_function=PostparsingValidators.isBetween(1, 5, inclusive=True, cast=int),
                    result_field_name="WORK_PART_STATUS",
            ...
            fields=[
                ...
                Field(
                    ...
                    validators=[
                        FieldValidators.orValidators([
                            PostparsingValidators.isBetween(0, 9, inclusive=True, cast=int),
                            PostparsingValidators.isOneOf(("11", "12")),
                        ])
                    ],
                ),
