        ...
        RowSchema(
            ...
            fields=[
                  ...
                  Field(item="4", name='RPT_MONTH_YEAR', type='number', startIndex=2, endIndex=8,
                        friendly_name="report month year", required=True,
                        validators=[validators.dateYearIsLargerThan(1998), validators.dateMonthIsValid(),]),
                  ...
                  TransformField(
                      transform_func=tanf_ssn_decryption_func, item="33", name='SSN', type='string', startIndex=29,
                  ...
                  Field(item="36B", name='FED_DISABILITY_STATUS', type='number',
                        startIndex=46, endIndex=47, required=True,
                        friendly_name="fed disability status", validators=[validators.oneOf([1, 2])]),
                  Field(item="36C", name='DISABLED_TITLE_XIVAPDT', type='string',
                        startIndex=47, endIndex=48, required=True,
                        friendly_name="disbaled title xivapdt",
                  ...
                  Field(item="39", name='PARENT_WITH_MINOR_CHILD', type='number',
                        startIndex=53, endIndex=54, required=False,
                        friendly_name="parent with minor child", validators=[validators.isInLimits(0, 3),]),
                  Field(item="40", name='NEEDS_PREGNANT_WOMAN', type='number',
                        startIndex=54, endIndex=55, required=False,
                  ...
                  Field(item="41", name='EDUCATION_LEVEL', type='string', startIndex=55, endIndex=57, required=False,
                        ...
                        validators=[
                            validators.or_validators(validators.isInStringRange(0, 16),
                                                     validators.isInStringRange(98, 99))
                                    ]),
                  ...
                  Field(item="43", name='COOPERATION_CHILD_SUPPORT', type='number', startIndex=58, endIndex=59,
                        friendly_name="coopeartion with child support", required=False,
                        validators=[validators.oneOf([0, 1, 2, 9]),]),
                  Field(item="44", name='MONTHS_FED_TIME_LIMIT', type='string',
                        startIndex=59, endIndex=62, required=False,
                        friendly_name="number of months countable toward federal time limit",
                        validators=[validators.isInStringRange(0, 999),]),
                  Field(item="45", name='MONTHS_STATE_TIME_LIMIT', type='string',
                        startIndex=62, endIndex=64, required=False,
                  ...
                  Field(item="48", name='WORK_ELIGIBLE_INDICATOR', type='string',
                        startIndex=66, endIndex=68, required=True,
                        friendly_name="work-eligible indivdual indicator",
                        validators=[
                            validators.or_validators(validators.isInStringRange(0, 9),
                  ...
                  Field(item="51", name='SUB_PRIVATE_EMPLOYMENT', type='string',
                        startIndex=72, endIndex=74, required=False,
                        friendly_name="subsidized private employment", validators=[validators.isInStringRange(0, 99),]),
                  Field(item="52", name='SUB_PUBLIC_EMPLOYMENT', type='string',
                        startIndex=74, endIndex=76, required=False,
                        friendly_name="subsidized public employment", validators=[validators.isInStringRange(0, 99),]),
                  Field(item="53A", name='WORK_EXPERIENCE_HOP', type='string',
                        startIndex=76, endIndex=78, required=False,
                        friendly_name="work experience - hours of participation",
                        validators=[validators.isInStringRange(0, 99),]),
                  Field(item="53B", name='WORK_EXPERIENCE_EA', type='string',
                        startIndex=78, endIndex=80, required=False,
                        friendly_name="work experience - excused absence",
                        validators=[validators.isInStringRange(0, 99),]),
                  Field(item="53C", name='WORK_EXPERIENCE_HOL', type='string',
                        startIndex=80, endIndex=82, required=False,
                  ...
                  Field(item="55A", name='JOB_SEARCH_HOP', type='string', startIndex=84, endIndex=86, required=False,
                        friendly_name="job search - hours of operation",
                        validators=[validators.isInStringRange(0, 99),]),
                  ...
                  Field(item="56A", name='COMM_SERVICES_HOP', type='string', startIndex=90, endIndex=92, required=False,
                        friendly_name="community service - hours of operation",
                        validators=[validators.isInStringRange(0, 99),]),
                  Field(item="56B", name='COMM_SERVICES_EA', type='string', startIndex=92, endIndex=94, required=False,
                        friendly_name="community service - excused absense",
                        validators=[validators.isInStringRange(0, 99),]),
                  ...
                  Field(item="65", name='EARNED_INCOME', type='string', startIndex=132, endIndex=136,
                        friendly_name="earned income", required=True,
                  ...
                  Field(item="66D", name='UNEARNED_WORKERS_COMP', type='string',
                        startIndex=148, endIndex=152, required=True,
                        friendly_name="unearned workers compensation",
                        validators=[validators.isInStringRange(0, 9999),]),
                  Field(item="66E", name='OTHER_UNEARNED_INCOME', type='string',
                        startIndex=152, endIndex=156, required=True,
