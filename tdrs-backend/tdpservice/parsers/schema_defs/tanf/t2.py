    ...
    RowSchema(
        ...
        fields=[
            ...
            TransformField(transform_func=tanf_ssn_decryption_func, item="33", name='SSN', type='string', startIndex=29,
                           endIndex=38, required=True, friendly_name='social security number',
            ...
            Field(item="36A", name='FED_OASDI_PROGRAM', type='number', startIndex=45, endIndex=46, required=True,
                  friendly_name='federal oasdi program',
                  validators=[validators.oneOf([1, 2])]),
            ...
            Field(item="40", name='NEEDS_PREGNANT_WOMAN', type='number', startIndex=54, endIndex=55, required=False,
                  friendly_name='needs pregnant woman',
            ...
            Field(item="44", name='MONTHS_FED_TIME_LIMIT', type='string', startIndex=59, endIndex=62, required=False,
                  friendly_name='months federal time limit',
            ...
            Field(item="45", name='MONTHS_STATE_TIME_LIMIT', type='string', startIndex=62, endIndex=64, required=False,
                  friendly_name='months state time limit',
            ...
            Field(item="51", name='SUB_PRIVATE_EMPLOYMENT', type='string', startIndex=72, endIndex=74, required=False,
                  friendly_name='subsidized provate employment',
                  validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="56A", name='COMM_SERVICES_HOP', type='string', startIndex=90, endIndex=92, required=False,
                  friendly_name='community services hrs of participation',
                  validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="57A", name='VOCATIONAL_ED_TRAINING_HOP', type='string', startIndex=96, endIndex=98,
                  friendly_name='vocational education training - hrs of participation',
            ...
            Field(item="58A", name='JOB_SKILLS_TRAINING_HOP', type='string', startIndex=102, endIndex=104,
                  friendly_name='job skills training hrs of participation',
                  required=False, validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="59A", name='ED_NO_HIGH_SCHOOL_DIPL_HOP', type='string', startIndex=108, endIndex=110,
                  friendly_name='education no high schoold diploma hrs of particiation',
                  required=False, validators=[validators.isInStringRange(0, 99),]),
            Field(item="59B", name='ED_NO_HIGH_SCHOOL_DIPL_EA', type='string', startIndex=110, endIndex=112,
                  friendly_name='education no high school diploma eacused absence',
                  required=False, validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="60A", name='SCHOOL_ATTENDENCE_HOP', type='string', startIndex=114, endIndex=116,
                  friendly_name='school attendance - hrs of participation',
                  required=False, validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="61A", name='PROVIDE_CC_HOP', type='string', startIndex=120, endIndex=122,
                  friendly_name='provide child care - hrs of participation',
                  required=False, validators=[validators.isInStringRange(0, 99),]),
            ...
            Field(item="66B", name='UNEARNED_SOCIAL_SECURITY', type='string', startIndex=140, endIndex=144,
                  friendly_name='un earned social security',
                  required=True, validators=[validators.isInStringRange(0, 9999),]),
