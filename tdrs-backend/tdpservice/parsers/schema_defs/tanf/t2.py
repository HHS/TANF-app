        ...
        RowSchema(
            ...
            fields=[
                ...
                Field(
                    ...
                    friendly_name="race americal indian",
                    type="number",
                    startIndex=39,
                    endIndex=40,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="fed qasdi program",
                    type="number",
                    startIndex=45,
                    endIndex=46,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="fed disability status",
                    type="number",
                    startIndex=46,
                    endIndex=47,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="coopeartion with child support",
                    type="number",
                    startIndex=58,
                    endIndex=59,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="employement status",
                    type="string",
                    startIndex=70,
                    endIndex=72,
                    required=True,
                ...
                Field(
                    item="55B",
                    name="JOB_SEARCH_EA",
                    friendly_name="job search - exceused absense",
                    type="string",
                    startIndex=86,
                    endIndex=88,
                    required=True,
                ...
                Field(
                    ...
                    friendly_name="community service - holiday",
                    type="string",
                    startIndex=94,
                    endIndex=96,
                    required=True,
