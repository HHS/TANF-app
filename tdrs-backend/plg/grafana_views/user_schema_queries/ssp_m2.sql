-- AUTOMATICALLY GENERATED FILE ON 2025-04-21 16:05:43
-- DO NOT EDIT - Your changes will be overwritten
-- Generated by generate_user_schema_queries.py

-- SQL query for ssp_m2 schema
-- Transformations applied:
--   * DATE_OF_BIRTH transformed to AGE calculation (as integer)
--   * SSN transformed to md5 hash for privacy


SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION","NONCUSTODIAL_PARENT",-- Calculate AGE_FIRST: Age as of the first day of the reporting month
                CASE 
                    WHEN "DATE_OF_BIRTH" ~ '^[0-9]{8}$' AND
                         -- Validate year (reasonable range)
                         CAST(SUBSTRING("DATE_OF_BIRTH" FROM 1 FOR 4) AS INTEGER) BETWEEN 1900 AND EXTRACT(YEAR FROM CURRENT_DATE) AND
...
FROM search_indexes_SSP_M2 M2
INNER JOIN
        data_files_datafile data_files                                             -- Join with data_files_datafile
        ON M2.datafile_id = data_files.id                              -- Join condition
    INNER JOIN (
        SELECT
