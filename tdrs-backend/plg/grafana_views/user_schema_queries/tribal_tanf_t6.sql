...
-- SQL query for tribal_tanf_t6 schema
-- Transformations applied:


SELECT "RecordType","CALENDAR_QUARTER","NUM_APPLICATIONS","NUM_APPROVED","NUM_DENIED","ASSISTANCE","NUM_FAMILIES","NUM_2_PARENTS","NUM_1_PARENTS","NUM_NO_PARENTS","NUM_RECIPIENTS","NUM_ADULT_RECIPIENTS","NUM_CHILD_RECIPIENTS","NUM_NONCUSTODIALS","NUM_BIRTHS","NUM_OUTWEDLOCK_BIRTHS","NUM_CLOSED_CASES", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
