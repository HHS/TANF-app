...
SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION",-- Calculate AGE_FIRST: Age as of the first day of the reporting month
                ...
                CASE 
                    ...
                    ELSE NULL 
                END AS "AGE_LAST",md5("SSN"::text) as "SSN_HASH","RACE_HISPANIC","RACE_AMER_INDIAN","RACE_ASIAN","RACE_BLACK","RACE_HAWAIIAN","RACE_WHITE","SEX","RECEIVE_NONSSI_BENEFITS","RECEIVE_SSI","RELATIONSHIP_HOH","PARENT_MINOR_CHILD","EDUCATION_LEVEL","CITIZENSHIP_STATUS","UNEARNED_SSI","OTHER_UNEARNED_INCOME", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
...
FROM search_indexes_SSP_M3 M3
INNER JOIN
        data_files_datafile data_files                                             -- Join with data_files_datafile
        ON M3.datafile_id = data_files.id                              -- Join condition
    INNER JOIN (
        SELECT
