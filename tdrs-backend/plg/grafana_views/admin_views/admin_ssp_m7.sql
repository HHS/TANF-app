...
-- SQL view for admin_ssp_m7 schema
-- Transformations applied:

CREATE OR REPLACE VIEW "admin_ssp_m7" AS SELECT "RecordType","CALENDAR_QUARTER","RPT_MONTH_YEAR","TDRS_SECTION_IND","STRATUM","FAMILIES_MONTH", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
