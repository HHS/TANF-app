...
-- SQL view for admin_tribal_tanf_t3 schema
-- Transformations applied:
--   * DATE_OF_BIRTH transformed to AGE calculation (as integer)

CREATE OR REPLACE VIEW "admin_tribal_tanf_t3" AS SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION","DATE_OF_BIRTH",-- Calculate AGE_FIRST: Age as of the first day of the reporting month
                CASE
                ...
                CASE
                    ...
                    ELSE NULL
                END AS "AGE_LAST","SSN","RACE_HISPANIC","RACE_AMER_INDIAN","RACE_ASIAN","RACE_BLACK","RACE_HAWAIIAN","RACE_WHITE","SEX","RECEIVE_NONSSA_BENEFITS","RECEIVE_SSI","RELATIONSHIP_HOH","PARENT_MINOR_CHILD","EDUCATION_LEVEL","CITIZENSHIP_STATUS","UNEARNED_SSI","OTHER_UNEARNED_INCOME", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
