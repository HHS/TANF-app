...
CREATE OR REPLACE VIEW "admin_tribal_tanf_t3" AS 
SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION","DATE_OF_BIRTH",--
...
INNER JOIN
    ...
    WHERE
        ...
        AND "FAMILY_AFFILIATION" != 0 AND "SEX" != 0
;
