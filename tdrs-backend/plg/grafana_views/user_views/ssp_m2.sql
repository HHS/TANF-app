...
CREATE OR REPLACE VIEW "ssp_m2" AS 
SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION","NONCUSTODIAL_PARENT",--
        ...
        CASE
            ...
            THEN 0
            ELSE 1
        END AS "AGE_VALID",md5("SSN"::text) as "SSN_HASH",--
