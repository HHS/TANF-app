...
CREATE OR REPLACE VIEW "ssp_m6" AS SELECT "RecordType","CALENDAR_QUARTER","SSPMOE_FAMILIES","NUM_2_PARENTS","NUM_1_PARENTS","NUM_NO_PARENTS","NUM_RECIPIENTS","ADULT_RECIPIENTS","CHILD_RECIPIENTS","NONCUSTODIALS","AMT_ASSISTANCE","CLOSED_CASES", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
