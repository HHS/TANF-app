...
-- SQL view for tribal_tanf_t3 schema
-- Transformations applied:
--   * DATE_OF_BIRTH transformed to AGE calculation (as integer)
--   * SSN transformed to md5 hash for privacy


CREATE OR REPLACE VIEW "tribal_tanf_t3" AS SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION",-- Calculate AGE_FIRST: Age as of the first day of the reporting month
        CASE
        ...
        END AS "AGE_VALID",md5("SSN"::text) as "SSN_HASH",CASE
            ...
            ELSE 0
        END AS "SSN_VALID","RACE_HISPANIC","RACE_AMER_INDIAN","RACE_ASIAN","RACE_BLACK","RACE_HAWAIIAN","RACE_WHITE","SEX","RECEIVE_NONSSA_BENEFITS","RECEIVE_SSI","RELATIONSHIP_HOH","PARENT_MINOR_CHILD","EDUCATION_LEVEL","CITIZENSHIP_STATUS","UNEARNED_SSI","OTHER_UNEARNED_INCOME", 
    data_files.section,
    data_files.version,
    data_files.year,
    data_files.quarter,
