...
-- SQL view for tribal_tanf_t2 schema
-- Transformations applied:
--   * DATE_OF_BIRTH transformed to AGE calculation (as integer)
--   * SSN transformed to md5 hash for privacy


CREATE OR REPLACE VIEW "tribal_tanf_t2" AS SELECT "RecordType","RPT_MONTH_YEAR","CASE_NUMBER","FAMILY_AFFILIATION","NONCUSTODIAL_PARENT",-- Calculate AGE_FIRST: Age as of the first day of the reporting month
        CASE
