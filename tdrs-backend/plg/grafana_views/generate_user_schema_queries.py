...
logger.info("Starting user schema query generation")
...
output_dir = 'user_schema_queries'
...
for schema_type, schemas in schema_data.items():
    for schema_name, fields in schemas.items():
        ...
        header_comment += "-- Generated by generate_user_schema_queries.py\n\n"
        header_comment += f"-- SQL query for {schema_type}_{schema_name} schema\n"
...
logger.info('All query files have been generated in the user_schema_queries directory.')
