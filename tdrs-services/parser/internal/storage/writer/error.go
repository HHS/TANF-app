...
// ConvertHeaderError creates a database error row for a header validation error.
// Header errors have row_number=1, no case_number, no object_id, no content_type_id.
func ConvertHeaderError(message string, errorType string, datafileID int32) []any {
	return []any{
