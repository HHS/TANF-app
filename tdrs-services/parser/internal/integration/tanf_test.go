...
func TestParseSmallTANFSection1(t *testing.T) {
	...
	ParseFile(t, ctx, testPool, testRegistry, testValidators, filePath, dfCtx)

	// Verify record counts
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t1", dfCtx.DatafileID, 5)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t2", dfCtx.DatafileID, 5)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t3", dfCtx.DatafileID, 6)

	// Verify T2 field values - Record 0
	t2_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t2", dfCtx.DatafileID, 0)
	...
	t2_1 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t2", dfCtx.DatafileID, 1)
	...
	t3_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t3", dfCtx.DatafileID, 0)
...
func TestParseBigTANFSection1(t *testing.T) {
	...
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t1", dfCtx.DatafileID, 815)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t2", dfCtx.DatafileID, 882)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t3", dfCtx.DatafileID, 1376)
}
...
func TestParseSmallTANFSection2(t *testing.T) {
	...
	// Verify record counts
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t4", dfCtx.DatafileID, 1)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t5", dfCtx.DatafileID, 1)

	// Verify T4 field values
	t4_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t4", dfCtx.DatafileID, 0)
	AssertFieldValue(t, t4_0, "DISPOSITION", int32(1))
	AssertFieldValue(t, t4_0, "REC_SUB_CC", int32(3))

	// Verify T5 field values
	t5_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t5", dfCtx.DatafileID, 0)
...
func TestParseBigTANFSection2(t *testing.T) {
	...
	// Verify record counts
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t4", dfCtx.DatafileID, 223)
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t5", dfCtx.DatafileID, 605)
}
...
func TestParseTANFSection3(t *testing.T) {
	...
	// Verify record counts
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t6", dfCtx.DatafileID, 3)
	...
	t6_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t6", dfCtx.DatafileID, 0)
	...
	t6_1 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t6", dfCtx.DatafileID, 1)
	AssertFieldValue(t, t6_1, "RPT_MONTH_YEAR", int32(202111))
	AssertFieldValue(t, t6_1, "NUM_APPROVED", int32(3977))

	t6_2 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t6", dfCtx.DatafileID, 2)
...
func TestParseTANFSection4(t *testing.T) {
	...
	AssertTableCount(t, ctx, testPool, "search_indexes_tanf_t7", dfCtx.DatafileID, 18)
	...
	t7_0 := QueryRecord(t, ctx, testPool, "search_indexes_tanf_t7", dfCtx.DatafileID, 0)
